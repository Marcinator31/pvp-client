...
public abstract class Module {
    ...
    /**
     * Wendet den aktuellen Zustand an, FALLS das Modul aktiviert ist --
     * ruft dann onEnable() auf (ohne den Wert zu aendern).
     *
     * Wird beim Client-Start einmal aufgerufen, damit Module, die ihre
     * Wirkung ueber onEnable() entfalten (z.B. AppleSkin/ShieldStatus per
     * Reflection) und standardmaessig an sind, ihren Effekt auch wirklich
     * setzen. enabledByDefault() setzt naemlich nur den Wert, ruft onEnable()
     * absichtlich nicht auf (das waere im Konstruktor zu frueh).
     *
     * WICHTIG: nur bei enabled=true wird onEnable() ausgeloest. Module, die
     * aus starten, bleiben unberuehrt -- so wird z.B. kein unnoetiges
     * onDisable() (mit reloadResources()) beim Start ausgeloest.
     */
