...
public final class Freecam {
     ...
     * kommen bereits vorskaliert aus changeLookDirection (Vanilla multipliziert
     * die Maus-Sensitivitaet schon vorher hinein), daher direkt anwenden.
     */
    public static void addRotation(double cursorDeltaX, double cursorDeltaY) {
        yaw += (float) cursorDeltaX;
        pitch += (float) cursorDeltaY;
