...
public final class BlockEspRenderer {
    ...
    // Hoch genug, dass auch grosse Reichweiten zuegig durchsucht werden, aber
    // pro Frame noch guenstig bleibt. (Reine Block-Lookups sind billig; das
    // Limit schuetzt nur vor Mega-Sweeps in einem einzigen Frame.)
    ...
    private static void stepScan(MinecraftClient client, BlockEspModule mod) {
        ...
        // Vertikal begrenzen wir staerker als horizontal: Bloecke, die man sucht
        // (Erze, Kisten, ...), liegen meist nah an der eigenen Hoehe, und die
        // volle Reichweite vertikal wuerde das Suchvolumen vervielfachen. Max
        // 64 Bloecke nach oben/unten -- horizontal bleibt die volle Reichweite.
