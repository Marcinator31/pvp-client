...
public final class ArmorHud {
    ...
    public static void render(DrawContext context, MinecraftClient client) {
        ...
        ItemStack[] stacks = new ItemStack[] {
            player.getEquippedStack(EquipmentSlot.HEAD),  // Helm
            player.getEquippedStack(EquipmentSlot.CHEST), // Brustplatte
            player.getEquippedStack(EquipmentSlot.LEGS),  // Hose
            player.getEquippedStack(EquipmentSlot.FEET),  // Schuhe
