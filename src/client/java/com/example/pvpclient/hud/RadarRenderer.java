...
public final class RadarRenderer {
    ...
    public static void render(DrawContext context, MinecraftClient client) {
        ...
        for (Entity e : client.world.getEntities()) {
            ...
            if (!drewEgg) {
                // Fallback-Punkt (Spieler, Items, oder Mob ohne Spawn-Ei).
    ...
    private static boolean drawMobEgg(DrawContext context,
        ...
        try {
            ...
            // Icon-Groesse: 8px Basis, leicht mit der Radar-Skalierung wachsend.
            int iconSize = Math.max(8, (int) Math.round(8 * scale));
    ...
    private static void drawPlayerInfo(DrawContext context, MinecraftClient client,
        ...
        try {
            // Kleinerer Kopf, damit der Radar nicht zugepflastert wird.
            int headSize = 7;
            int hx = dotX + 3;
