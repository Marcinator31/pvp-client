...
/**
 * Zeichnet die HUD-Overlays -- ueber die NEUE HudElementRegistry-API.
 *
 * WICHTIG: Das alte HudRenderCallback ist in dieser Fabric-Version
 * veraltet und feuert NICHT mehr -- deshalb wurde vorher nichts gezeichnet,
 * obwohl die Module korrekt aktiviert waren.
 *
 * Jetzt haengen wir ein HUD-Element ueber die Registry an. Das Element
 * ist ein Lambda (DrawContext, tickCounter), das nach den Vanilla-
 * Misc-Overlays gezeichnet wird.
 */
